...
// handler_event 和handle_expired_event() 都是事件处理
...
int main()
{
    ...
    while (true)
    {
        ...
        // 遍历events数组，根据监听种类及描述符类型分发操作,正常监听
